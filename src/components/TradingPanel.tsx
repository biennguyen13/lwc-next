  ...
  return (
    <div className="rounded-lg p-2 space-y-6">
      ...
      <div className="space-y-3">
        <h3 className="text-white  text-base">Giá trị</h3>
        
        {/* Value Input */}
        <div className="flex items-center gap-1">
          <button
            onClick={() => handleValueChange(Math.max(0, value - 5))}
            className="w-10 h-10 bg-gray-600 hover:bg-gray-500 text-white rounded flex items-center justify-center transition-colors"
          >
            -
          </button>
          <div className="flex-1 px-1 h-10 flex items-center relative border border-gray-700 rounded">
            <span className="text-white text-base">${value}</span>
            <button
              onClick={() => handleValueChange(0)}
              className="absolute right-1 top-1/2 transform -translate-y-1/2 w-5 h-5 bg-gray-500 hover:bg-gray-400 text-white rounded-full flex items-center justify-center transition-colors text-xs"
            >
              ×
            </button>
          </div>
        ...
        <div className="grid grid-cols-3 gap-1">
          {quickValues.map((quickValue) => (
            <button
              ...
              className="px-3 py-2 bg-gray-700 hover:bg-gray-600 text-white rounded-xl transition-colors text-sm font-medium"
            >
              +{quickValue}
            </button>
          ))}
      ...
      <div className="space-y-2">
        <div className="flex items-center gap-2 justify-center">
          <div className="text-white text-base">Lợi nhuận</div>
          <div className="text-cyan-400">{profitPercentage}%</div>
        </div>
      ...
      <div className="space-y-2">
        <h3 className="text-white text-xs text-center">Chỉ báo tâm lý</h3>
      ...
      <div className="space-y-3">
        ...
        <button
          ...
          className="w-full py-4 bg-red-600 hover:bg-red-500 text-white font-bold text-base rounded-lg transition-colors flex items-center justify-center gap-2"
        >
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
